...
export enum ActionsEnum {
    ...
    createResourceMtlsCertificate = "createResourceMtlsCertificate",
    deleteResourceMtlsCertificate = "deleteResourceMtlsCertificate",
    listResourceMtlsCertificates = "listResourceMtlsCertificates",
